...
namespace Santuarivm
{
    ...
    {
        public CanguruVermelho()
        {

        }

        public override ImageSource Imagem { get { return new BitmapImage(new Uri("Imagens/canguru.png", UriKind.Relative)); } }

        public CanguruVermelho(string nome, DateTime nascimento, string sexo,string cor) 
        ...
        public override string Especie { get { return "Canguru Vermelho"; } }

        public override string Comunicar() { return "Audios/canguru.wav"; }
    }
}
