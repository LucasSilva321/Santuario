...
namespace Santuarivm
{
    class Dingo : Mamifero,ITerrestre
    {
        ...
        public Dingo(string nome, DateTime nascimento, string sexo,string cor) 
        ...
        public override int qtdeMamas { get { return 8; } }
        ...
        public override string Especie { get { return "Dingo"; } }

        public override ImageSource Imagem { get { return new BitmapImage(new Uri("Imagens/dingo.png", UriKind.Relative)); } }

        public override string Comunicar() { return "Audios/dingo.wav"; }
    }
}
